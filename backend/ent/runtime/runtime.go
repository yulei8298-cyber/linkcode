...
func init() {
	...
	// groupDescIsHidden is the schema descriptor for is_hidden field.
	groupDescIsHidden := groupFields[11].Descriptor()
	// group.DefaultIsHidden holds the default value on creation for the is_hidden field.
	group.DefaultIsHidden = groupDescIsHidden.Default.(bool)
	// groupDescIsFree is the schema descriptor for is_free field.
	groupDescIsFree := groupFields[12].Descriptor()
	...
	// groupDescChatStationOnly is the schema descriptor for chat_station_only field.
	groupDescChatStationOnly := groupFields[14].Descriptor()
	// group.DefaultChatStationOnly holds the default value on creation for the chat_station_only field.
	group.DefaultChatStationOnly = groupDescChatStationOnly.Default.(bool)
