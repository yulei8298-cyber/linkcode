...
func TestLinuxDoOAuthCallbackDirectlyLogsInNewUserWhenEmailVerificationEnabled(t *testing.T) {
	...
	handler, client := newLinuxDoOAuthHandlerAndClientWithEmailVerificationEnabled(t, false, true, config.LinuxDoConnectConfig{
		Enabled:             true,
		ClientID:            "linuxdo-client",
		ClientSecret:        "linuxdo-secret",
		AuthorizeURL:        upstream.URL + "/authorize",
...
func newLinuxDoOAuthHandlerAndClientWithEmailVerificationEnabled(
	t *testing.T,
	invitationEnabled bool,
