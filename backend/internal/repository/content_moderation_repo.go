...
INSERT INTO content_moderation_logs (
    ...
    $22, $23, $24, $25, $26
		...
		string(categoryScores), string(thresholdSnapshot), log.InputExcerpt, log.InputHash, latency, log.Error,
...
SELECT
    ...
    l.category_scores, l.threshold_snapshot, l.input_excerpt, l.input_hash, l.upstream_latency_ms, l.error,
