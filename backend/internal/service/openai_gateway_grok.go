...
func patchGrokResponsesBody(body []byte, upstreamModel string) ([]byte, error) {
	...
	out, err = stripGrok45UnsupportedRequestFields(out, upstreamModel)
	if err != nil {
		return nil, err
	}
...
// stripGrok45UnsupportedRequestFields removes request parameters rejected by
// the Grok 4.5 Chat Completions and Responses APIs. Keep this shared by both
// forwarding paths so OpenAI-compatible clients can use either casing safely.
func stripGrok45UnsupportedRequestFields(body []byte, upstreamModel string) ([]byte, error) {
