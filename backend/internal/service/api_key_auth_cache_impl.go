...
const apiKeyAuthSnapshotVersion = 16 // v16: include free-group billing and chat-station-only authorization fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			DailyFreeLimitUSD:               apiKey.Group.DailyFreeLimitUSD,
			ChatStationOnly:                 apiKey.Group.ChatStationOnly,
			DailyLimitUSD:                   apiKey.Group.DailyLimitUSD,
			WeeklyLimitUSD:                  apiKey.Group.WeeklyLimitUSD,
			MonthlyLimitUSD:                 apiKey.Group.MonthlyLimitUSD,
			IPWhitelist:                     apiKey.Group.IPWhitelist,
			IPBlacklist:                     apiKey.Group.IPBlacklist,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			DailyFreeLimitUSD:               snapshot.Group.DailyFreeLimitUSD,
			ChatStationOnly:                 snapshot.Group.ChatStationOnly,
			DailyLimitUSD:                   snapshot.Group.DailyLimitUSD,
			WeeklyLimitUSD:                  snapshot.Group.WeeklyLimitUSD,
			MonthlyLimitUSD:                 snapshot.Group.MonthlyLimitUSD,
			IPWhitelist:                     snapshot.Group.IPWhitelist,
			IPBlacklist:                     snapshot.Group.IPBlacklist,
