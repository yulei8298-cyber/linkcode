...
func (s *APIKeyService) Delete(ctx context.Context, id int64, userID int64) error {
	...
	// A key whose referenced group has been deleted is intentionally invalid for
	// authentication, but its owner must still be able to remove the orphaned key.
	// Existing hidden-group keys remain protected from user management.
	if apiKey.Group != nil && apiKey.Group.IsHidden {
