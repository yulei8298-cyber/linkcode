...
func (s *OpenAIGatewayService) handleStreamingResponsePassthrough(
	...
	for documentScanner.Scan() {
		...
		if data, ok := extractOpenAISSEDataLine(line); ok {
			...
			lineStartsFirstToken = openAIStreamDataStartsStructuralProgress(trimmedData, eventType) && !openAIStreamEventTypeIsTerminal(eventType)
			...
			if firstTokenMs == nil && lineStartsFirstToken {
