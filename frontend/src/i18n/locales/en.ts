    ...
    settings: {
      ...
      site: {
        ...
        pricingDisplayConfigHint:
          'Controls the pricing page, including recharge ratio ranges, campaign notes, recommended amounts, benefit notes, button text, and channel-rate description template.',
