export default {
  ...
  portal: {
    nav: { status: 'Status', pricing: 'Pricing', tutorial: 'Tutorial', chat: 'Chat' },
    status: { title: 'Channel Status', subtitle: 'Real-time availability, latency and uptime across channels' },
    pricing: { title: 'Pricing', subtitle: 'Real-time billing rates for channels, groups and models' },
    tutorial: {
      title: 'Tutorial',
    ...
    stats: { providers: 'Providers', lowestRate: 'Lowest Rate', balance: 'Balance Validity', permanentValue: 'Forever' },
    features: {
      status: 'Status Check', statusDesc: 'Monitor channel status and latency in real time',
      pricing: 'Transparent Pricing', pricingDesc: 'Token-based billing with clear rate multipliers',
      tutorial: 'Tutorial', tutorialDesc: 'Step-by-step onboarding guide',
      chat: 'Chat Station', chatDesc: 'Try it online, ready to use', soon: 'Soon'
    },
    why: {
      title: 'Why Choose Us',
