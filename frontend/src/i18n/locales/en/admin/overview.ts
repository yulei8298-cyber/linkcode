export default {
    ...
    backup: {
      ...
      imageStorage: {
        ...
        description: 'Offloads synchronous and asynchronous image results to object storage. Base64, data URLs, and remote upstream URLs are normalized to the configured public domain or a presigned link; async tasks keep only short links in Redis. Shares the S3 client with backups and takes effect on save without a restart.',
        enabled: 'Enable image object storage',
    ...
    groups: {
      ...
      modelsList: {
        title: 'Model list',
        hint: 'Choose models available through this group.',
      ...
      form: {
        ...
        userHidden: 'Hide from users',
        userHiddenHint: 'Users cannot select this group for new keys, and existing keys in this group are hidden from their API key list.',
        freeGroup: 'Daily free group',
        freeGroupHint: 'Available only in standard balance mode. Requests do not deduct balance and actual cost is tracked per user per day.',
        dailyFreeLimit: 'Daily free allowance (USD)',
        dailyFreeLimitPlaceholder: 'Enter a daily allowance greater than 0',
        dailyFreeLimitRequired: 'Free groups must use standard billing and have a daily free allowance greater than 0',
        chatStationOnly: 'Chat station requests only',
        chatStationOnlyHint: 'Only requests carrying the correct chat station shared secret may use this group.',
