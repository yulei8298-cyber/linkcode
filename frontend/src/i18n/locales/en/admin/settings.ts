export default {
    settings: {
      ...
      site: {
        ...
        pricingDisplayConfig: 'Pricing Page Display Config',
        pricingDisplayConfigPlaceholder: 'JSON format. Leave empty to use defaults.',
        pricingDisplayConfigHint: 'Controls the pricing page, including recharge ratio ranges, campaign notes, recommended amounts, benefit notes, button text, and channel-rate description template.',
        pricingDisplayConfigReset: 'Use Default Template',
        pricingDisplayConfigFormatError: 'Pricing page display config is not valid JSON. Please check it before saving.',
        ...
        qqGroup: 'QQ Group',
        qqGroupPlaceholder: 'e.g., 1025176993',
        qqGroupHint: 'QQ group number shown in the public portal top bar and community section. Leave blank to hide it.',
        telegramGroupUrl: 'Telegram Group URL',
        telegramGroupUrlPlaceholder: 'https://t.me/your_group',
        telegramGroupUrlHint: 'Telegram entry shown in the public portal top bar and community section. Leave blank to hide it.',
