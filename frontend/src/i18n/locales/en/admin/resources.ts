export default {
    ...
    redeem: {
      ...
      columns: {
        ...
        type: 'Type',
        value: 'Value',
        affiliateRebateBaseAmount: 'Rebate Basis',
        status: 'Status',
        usedBy: 'Used By',
        usedAt: 'Used At',
      ...
      amount: 'Amount ($)',
      value: 'Value',
      affiliateRebateBaseAmount: 'Rebate Basis (Paid Amount)',
      affiliateRebateBaseAmountPlaceholder: 'Leave empty to use face value',
      affiliateRebateBaseAmountInvalid: 'Rebate basis must be between 0 and the face value',
      count: 'Count',
