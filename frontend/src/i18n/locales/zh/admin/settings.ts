export default {
    settings: {
      ...
      site: {
        ...
        pricingDisplayConfigHint: '用于定价方案页面，可配置充值比例范围、活动说明、推荐金额、福利说明、按钮文案、渠道倍率描述模板等。',
        ...
        qqGroup: 'QQ群',
        qqGroupPlaceholder: '例如：1025176993',
        qqGroupHint: '公开门户顶部与首页社群区域展示的QQ群号。留空则隐藏。',
        telegramGroupUrl: 'Telegram 群链接',
        telegramGroupUrlPlaceholder: 'https://t.me/your_group',
        telegramGroupUrlHint: '公开门户顶部与社群区域的 Telegram 入口。留空则隐藏。',
