export default {
    ...
    redeem: {
      ...
      columns: {
        ...
        type: '类型',
        value: '面值',
        affiliateRebateBaseAmount: '返利基数',
        status: '状态',
        usedBy: '使用者',
        usedAt: '使用时间',
        expiresAt: '过期时间',
      ...
      amount: '金额 ($)',
      value: '面值',
      affiliateRebateBaseAmount: '返利计算金额（实收/成本）',
      affiliateRebateBaseAmountPlaceholder: '留空按面值返利',
      affiliateRebateBaseAmountInvalid: '返利计算金额必须在 0 和面值之间',
      count: '数量',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
