...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      descriptionKey: 'infiniteCanvas.subtitle'
    }
  },
  {
    path: '/usage',
  ...
  },
  {
    ...
    name: 'AdminModelBasePricing',
    component: () => import('@/views/admin/ModelBasePricingView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Model Base Pricing',
      titleKey: 'nav.modelBasePricing'
    }
  },
  {
    path: '/monitor',
