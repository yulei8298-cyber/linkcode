...
| `ADMIN_EMAIL` | No | `yulei8298@gmail.com` | Admin email |
| `ADMIN_PASSWORD` | No | `yulei19970826qq..` | Admin password |
...
# 安全说明：本仓库不会内置这些第三方 OAuth 凭据，请在运行环境通过环境变量注入。
# GEMINI_CLI_OAUTH_CLIENT_ID=your-gemini-cli-client-id.apps.googleusercontent.com
...
2. Add your OAuth credentials in the `[Service]` section (after the existing `Environment=` lines):
   ...
   ```ini
   Environment=GEMINI_CLI_OAUTH_CLIENT_ID=your-gemini-cli-client-id.apps.googleusercontent.com
